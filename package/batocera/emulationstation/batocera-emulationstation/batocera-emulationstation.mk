...
BATOCERA_EMULATIONSTATION_SITE = https://github.com/AmrMantawi/batocera.AI-emulationstation
...
define BATOCERA_EMULATIONSTATION_COPY_SUBMODULES
	cp -r /sources/batocera.AI-emulationstation/external/pugixml $(@D)/external/
endef
...
BATOCERA_EMULATIONSTATION_PRE_CONFIGURE_HOOKS += BATOCERA_EMULATIONSTATION_COPY_SUBMODULES
